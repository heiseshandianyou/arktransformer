...
class DatePickerDialogPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.selectedDate = new Date("2023-12-1");
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/dialog/DatePickerDialogPage.ets(19:5)");
            Column.height('100%');
            Column.width('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 导航栏---------------------------------------------------------------------
            Column.create();
            Column.debugLine("pages/dialog/DatePickerDialogPage.ets(21:7)");
            if (!isInitialRender) {
                // 导航栏---------------------------------------------------------------------
                Column.pop();
            }
        ...
        });
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                if (isInitialRender) {
                    ViewPU.create(new Title(this, { pageTitle: 'DatePickerDialog 日期选择弹窗' }, undefined, elmtId));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(elmtId, {
                        pageTitle: 'DatePickerDialog 日期选择弹窗'
                    });
                }
                ViewStackProcessor.StopGetAccessRecording();
            });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 组件预览区---------------------------------------------------------------------
            Blank.create();
            Blank.debugLine("pages/dialog/DatePickerDialogPage.ets(26:7)");
            if (!isInitialRender) {
                // 组件预览区---------------------------------------------------------------------
                Blank.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/dialog/DatePickerDialogPage.ets(27:7)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/dialog/DatePickerDialogPage.ets(28:9)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('DatePickerDialog');
            Text.debugLine("pages/dialog/DatePickerDialogPage.ets(31:9)");
            Text.fontSize(16);
            Text.height(40);
            Text.padding(8);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("pages/dialog/DatePickerDialogPage.ets(48:7)");
            if (!isInitialRender) {
                Blank.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 组件配置区---------------------------------------------------------------------
            Column.create();
            Column.debugLine("pages/dialog/DatePickerDialogPage.ets(50:7)");
            // 组件配置区---------------------------------------------------------------------
...
loadDocument(new DatePickerDialogPage(undefined, {}));
ViewStackProcessor.StopGetAccessRecording();
//# sourceMappingURL=DatePickerDialogPage.js.map