...
class ActionSheetPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        ...
        this.__offset_dy = new ObservedPropertySimplePU(0, this, "offset_dy");
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/dialog/ActionSheetPage.ets(53:5)");
            Column.height('100%');
            Column.width('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 导航栏---------------------------------------------------------------------
            Column.create();
            Column.debugLine("pages/dialog/ActionSheetPage.ets(55:7)");
            if (!isInitialRender) {
                // 导航栏---------------------------------------------------------------------
                Column.pop();
            }
        ...
        });
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                if (isInitialRender) {
                    ViewPU.create(new Title(this, { pageTitle: 'ActionSheet 列表选择弹窗' }, undefined, elmtId));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(elmtId, {
                        pageTitle: 'ActionSheet 列表选择弹窗'
                    });
                }
                ViewStackProcessor.StopGetAccessRecording();
            });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 组件预览区---------------------------------------------------------------------
            Blank.create();
            Blank.debugLine("pages/dialog/ActionSheetPage.ets(60:7)");
            if (!isInitialRender) {
                // 组件预览区---------------------------------------------------------------------
                Blank.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/dialog/ActionSheetPage.ets(61:7)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('Show ActionSheet');
            Text.debugLine("pages/dialog/ActionSheetPage.ets(62:9)");
            Text.fontSize(16);
            Text.height(40);
            Text.padding(8);
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("pages/dialog/ActionSheetPage.ets(96:7)");
            if (!isInitialRender) {
                Blank.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 组件配置区---------------------------------------------------------------------
            Column.create();
            Column.debugLine("pages/dialog/ActionSheetPage.ets(98:7)");
            // 组件配置区---------------------------------------------------------------------
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 组件属性 tab
            Column.create();
            Column.debugLine("pages/dialog/ActionSheetPage.ets(100:9)");
            // 组件属性 tab
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Divider.create();
            Divider.debugLine("pages/dialog/ActionSheetPage.ets(102:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Divider.create();
            Divider.debugLine("pages/dialog/ActionSheetPage.ets(109:11)");
            Divider.color({ "id": 16777244, "type": 10001, params: [], "bundleName": "com.gudaoessay.arkuicomponentdemo", "moduleName": "entry" });
            if (!isInitialRender) {
                Divider.pop();
            }
        ...
        });
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                if (isInitialRender) {
                    ViewPU.create(new CustomSlider(this, { name: 'offset_dx', value: this.__offset_dx, min: -100, max: 100 }, undefined, elmtId));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(elmtId, {
                        name: 'offset_dx', min: -100, max: 100
                    });
                }
                ViewStackProcessor.StopGetAccessRecording();
            });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Divider.create();
            Divider.debugLine("pages/dialog/ActionSheetPage.ets(111:11)");
            Divider.color({ "id": 16777244, "type": 10001, params: [], "bundleName": "com.gudaoessay.arkuicomponentdemo", "moduleName": "entry" });
            if (!isInitialRender) {
                Divider.pop();
            }
        ...
        });
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                if (isInitialRender) {
                    ViewPU.create(new CustomSlider(this, { name: 'offset_dy', value: this.__offset_dy, min: -100, max: 100 }, undefined, elmtId));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(elmtId, {
                        name: 'offset_dy', min: -100, max: 100
                    });
                }
                ViewStackProcessor.StopGetAccessRecording();
            });
...
loadDocument(new ActionSheetPage(undefined, {}));
ViewStackProcessor.StopGetAccessRecording();
//# sourceMappingURL=ActionSheetPage.js.map