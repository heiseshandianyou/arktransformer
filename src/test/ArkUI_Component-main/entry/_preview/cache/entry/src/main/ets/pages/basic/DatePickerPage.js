...
class DatePickerPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        super(parent, __localStorage, elmtId);
        this.__selectTab = new ObservedPropertySimplePU(1, this, "selectTab");
        this.__date = new ObservedPropertySimplePU('选择日期'
        // lunar 是否为农历
        , this, "date");
        this.__lunar = new ObservedPropertySimplePU(false
        // width 通用宽度属性
        , this, "lunar");
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/basic/DatePickerPage.ets(27:5)");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 导航栏---------------------------------------------------------------------
            Column.create();
            Column.debugLine("pages/basic/DatePickerPage.ets(29:7)");
            if (!isInitialRender) {
                // 导航栏---------------------------------------------------------------------
                Column.pop();
            }
        ...
        });
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                if (isInitialRender) {
                    ViewPU.create(new Title(this, { pageTitle: 'DatePicker 日期选择' }, undefined, elmtId));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(elmtId, {
                        pageTitle: 'DatePicker 日期选择'
                    });
                }
                ViewStackProcessor.StopGetAccessRecording();
            });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 组件预览区 ---------------------------------------------------------------------
            Blank.create();
            Blank.debugLine("pages/basic/DatePickerPage.ets(35:7)");
            if (!isInitialRender) {
                // 组件预览区 ---------------------------------------------------------------------
                Blank.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/basic/DatePickerPage.ets(36:7)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            DatePicker.create();
            DatePicker.debugLine("pages/basic/DatePickerPage.ets(37:9)");
            DatePicker.lunar(this.lunar);
            DatePicker.onChange(value => {
                this.changeHandle(value);
            });
            DatePicker.width(this.widthValue);
            DatePicker.height(this.heightValue);
            if (!isInitialRender) {
                DatePicker.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Text.debugLine("pages/basic/DatePickerPage.ets(44:9)");
            Text.margin({ top: 24 });
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("pages/basic/DatePickerPage.ets(49:7)");
            if (!isInitialRender) {
                Blank.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 组件配置区---------------------------------------------------------------------
            Column.create();
            Column.debugLine("pages/basic/DatePickerPage.ets(51:7)");
            // 组件配置区---------------------------------------------------------------------
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 组件属性 tab
            Column.create();
            Column.debugLine("pages/basic/DatePickerPage.ets(53:9)");
            // 组件属性 tab
        ...
        });
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                if (isInitialRender) {
                    ViewPU.create(new CustomSwitch(this, { name: 'lunar', isOn: this.__lunar }, undefined, elmtId));
                }
                else {
                    this.updateStateVarsOfChildByElmtId(elmtId, {
                        name: 'lunar'
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 通用属性 tab
            Column.create();
            Column.debugLine("pages/basic/DatePickerPage.ets(59:9)");
            // 通用属性 tab
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Divider.create();
            Divider.debugLine("pages/basic/DatePickerPage.ets(61:11)");
...
loadDocument(new DatePickerPage(undefined, {}));
ViewStackProcessor.StopGetAccessRecording();
