...
class RadioPage extends ViewPU {
    constructor(parent, params, __localStorage, elmtId = -1) {
        super(parent, __localStorage, elmtId);
        this.__selectTab = new ObservedPropertySimplePU(2
        // width 宽度通用属性
        , this, "selectTab");
    ...
    initialRender() {
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Column.create();
            Column.debugLine("pages/basic/RadioPage.ets(19:5)");
            Column.height('100%');
            Column.width('100%');
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 导航栏---------------------------------------------------------------------
            Column.create();
            Column.debugLine("pages/basic/RadioPage.ets(21:7)");
            if (!isInitialRender) {
                // 导航栏---------------------------------------------------------------------
                Column.pop();
            }
        ...
        });
        {
            this.observeComponentCreation((elmtId, isInitialRender) => {
                ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
                if (isInitialRender) {
                    ViewPU.create(new Title(this, { pageTitle: 'Radio 单选框' }, undefined, elmtId));
                }
                else {
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 组件预览区---------------------------------------------------------------------
            Blank.create();
            Blank.debugLine("pages/basic/RadioPage.ets(26:7)");
            if (!isInitialRender) {
                // 组件预览区---------------------------------------------------------------------
                Blank.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Column.create();
            Column.debugLine("pages/basic/RadioPage.ets(27:7)");
            if (!isInitialRender) {
                Column.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/basic/RadioPage.ets(28:9)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Radio.debugLine("pages/basic/RadioPage.ets(29:11)");
            Radio.checked(true);
            Radio.width(this.widthValue);
            if (!isInitialRender) {
                Radio.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('选项1');
            Text.debugLine("pages/basic/RadioPage.ets(31:11)");
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/basic/RadioPage.ets(35:9)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Radio.debugLine("pages/basic/RadioPage.ets(36:11)");
            Radio.checked(true);
            Radio.width(this.widthValue);
            if (!isInitialRender) {
                Radio.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('选项2');
            Text.debugLine("pages/basic/RadioPage.ets(38:11)");
            Text.fontColor({ "id": 16777243, "type": 10001, params: [], "bundleName": "com.gudaoessay.arkuicomponentdemo", "moduleName": "entry" });
            if (!isInitialRender) {
                Text.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Row.create();
            Row.debugLine("pages/basic/RadioPage.ets(42:9)");
            if (!isInitialRender) {
                Row.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            Radio.debugLine("pages/basic/RadioPage.ets(43:11)");
            Radio.checked(true);
            Radio.width(this.widthValue);
            if (!isInitialRender) {
                Radio.pop();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Text.create('选项3');
            Text.debugLine("pages/basic/RadioPage.ets(45:11)");
            Text.fontColor({ "id": 16777243, "type": 10001, params: [], "bundleName": "com.gudaoessay.arkuicomponentdemo", "moduleName": "entry" });
            if (!isInitialRender) {
                Text.pop();
            }
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ViewStackProcessor.StartGetAccessRecordingFor(elmtId);
            Blank.create();
            Blank.debugLine("pages/basic/RadioPage.ets(50:7)");
            if (!isInitialRender) {
                Blank.pop();
            }
            ViewStackProcessor.StopGetAccessRecording();
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 组件配置区---------------------------------------------------------------------
            Column.create();
            Column.debugLine("pages/basic/RadioPage.ets(52:7)");
            // 组件配置区---------------------------------------------------------------------
        ...
        this.observeComponentCreation((elmtId, isInitialRender) => {
            ...
            // 通用属性 tab
            Column.create();
            Column.debugLine("pages/basic/RadioPage.ets(55:9)");
            // 通用属性 tab
...
loadDocument(new RadioPage(undefined, {}));
ViewStackProcessor.StopGetAccessRecording();
//# sourceMappingURL=RadioPage.js.map